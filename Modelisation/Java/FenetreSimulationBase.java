...
public class FenetreSimulationBase extends BorderPane {
    ...
    public FenetreSimulationBase() {
        ...
        HBox.setMargin(button11114, new Insets(0.0, 8.0, 0.0, 8.0));
