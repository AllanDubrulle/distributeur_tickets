...
class FHoraireMenu extends Ecran 
{
	public FHoraireMenu(double hauteur, double largeur) 
    {
        ...
        texte.setText("Verifier un horaire de train");
        ...
        texte0.setText("Selectionner une option :");
        ...
        texte1.setText(":      Permet de consulter les departs a partir d'une gare");
        ...
        texte2.setText(":      Permet de consulter les arrivees dans une gare");
        ...
        texte3.setText(":      Permet de consulter l'horaire d'un itineraire entre deux gares");
