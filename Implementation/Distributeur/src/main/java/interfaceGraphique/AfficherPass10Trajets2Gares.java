...
class AfficherPass10Trajets2Gares extends Pane 
{
    public AfficherPass10Trajets2Gares(String nom, String gareDepart, String gareArrivee, int classe, String reduction, String type, double prix) 
    {
        ...
        text.setText("PASS 10 TRAJETS 2 GARES");
        ...
        text4.setWrappingWidth(170.0);
        HBox.setMargin(text4, new Insets(0.0, 5.0, 0.0, 5.0));

        text5.setStrokeType(javafx.scene.shape.StrokeType.OUTSIDE);
        text5.setStrokeWidth(0.0);
        text5.setText("De :");
        text5.setTextAlignment(javafx.scene.text.TextAlignment.CENTER);
        text5.setWrappingWidth(170.0);
        HBox.setMargin(text5, new Insets(0.0, 5.0, 0.0, 5.0));

        text6.setStrokeType(javafx.scene.shape.StrokeType.OUTSIDE);
        text6.setStrokeWidth(0.0);
        text6.setText("A :");
        text6.setTextAlignment(javafx.scene.text.TextAlignment.CENTER);
        text6.setWrappingWidth(170.0);
        HBox.setMargin(text6, new Insets(0.0, 5.0, 0.0, 5.0));
        ...
        VBox.setMargin(hBox12, new Insets(0.0, 20.0, 0.0, 20.0));
