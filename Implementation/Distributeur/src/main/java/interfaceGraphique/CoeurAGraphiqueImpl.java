...
/**
 * Classe CoeurAGraphiqueImpl (permet au coeur de communiquer avec l'interface graphique)
...
public class CoeurAGraphiqueImpl implements CoeurAGraphique
{
	...
	/**
	 * 	Constructeur de CoeurAGraphiqueImpl
	 */
	private CoeurAGraphiqueImpl(){}
	
	/**
	 *	Permet de recupererer l'instance unique de CoeurAGraphiqueImpl (Singleton Design Pattern)
	 *	@return instance l'instance de CoeurAGraphiqueImpl
	 */
