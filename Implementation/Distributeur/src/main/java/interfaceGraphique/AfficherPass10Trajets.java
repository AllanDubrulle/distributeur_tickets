...
/**
 * Classe AfficherPass10Trajets (permet d'afficher le pass achete)
...
{
	/**
	 * 	Constructeur de AfficherPass10Trajets
    ...
    public AfficherPass10Trajets(String nom, int classe, String reduction, String type, double prix) 
    {
        ...
        texte1.setText("PASS 10 TRAJETS");
        ...
        VBox.setMargin(boxHor14, new Insets(0.0, 20.0, 5.0, 20.0));
        ...
        boxVer.getChildren().addAll(boxHor1, boxHor2, boxHor3, boxHor4, boxHor5, boxHor6, boxHor7, 
        		boxHor8, boxHor9, boxHor10, boxHor11, boxHor12, boxHor13, boxHor14, boxHor15);
