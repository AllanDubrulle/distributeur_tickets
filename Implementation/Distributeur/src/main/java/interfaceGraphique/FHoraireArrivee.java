...
class FHoraireArrivee extends Ecran 
{
    ...
    public FHoraireArrivee(double hauteur, double largeur) 
    {
        ...
        texte.setText("Verifier un horaire de train (arrivees)");
        texte.setUnderline(true);
        texte.setFont(new Font("System Bold", 22.0*hauteur));

        hBox.setLayoutX(60.0*largeur);
        hBox.setLayoutY(162.0*hauteur);
        hBox.setPrefHeight(20.0*hauteur);
        ...
        VBox.setMargin(zoneTexte, new Insets(0.0, 0.0, 5.0*hauteur, 0.0));
        			...
        			try 
        			{
        				if(graphAC.existenceGare(zoneTexte.getText()))
        				{
        					if (Integer.parseInt(zoneTexte0.getText()) < 24 && Integer.parseInt(zoneTexte1.getText()) < 60)
        						graphAC.choixRechercheGA(zoneTexte.getText(), Integer.parseInt(zoneTexte0.getText()), Integer.parseInt(zoneTexte1.getText()));
        					else 
