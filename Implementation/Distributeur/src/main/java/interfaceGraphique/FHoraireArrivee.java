...
class FHoraireArrivee extends Ecran 
{
    ...
    public FHoraireArrivee(double hauteur, double largeur) 
    {
        ...
        text.setText("Vérifier un horaire de train (arrivées)");
        ...
        text0.setText("Arrivées dans une gare : ");
        text0.setWrappingWidth(180.0*largeur);
        text0.setFont(new Font(15.0*hauteur));
        VBox.setMargin(text0, new Insets(5.0*hauteur, 0.0, 5.0*hauteur, 0.0));
        ...
        VBox.setMargin(textField, new Insets(0.0, 0.0, 5.0*hauteur, 0.0));
